...
<body>
    ...
    <div class="modal-overlay" id="how-to-play-modal">
        <div class="modal">
                ...
                <div class="modal-title">How to Play Card Games</div>
    ...
    <div class="modal-section-content">
        <ul>
            <li>እጁ ላይ ያለውን ቀድሞ የጨረሰ ያሸንፋል ለሁለቱም ሰው 7 ካርታ ነው ሲጀመር ሚያደለው።</li>
            ...
            <li>መጫወት ካልቻሉ መሳብ አለባቹ አሁንም ሚጫወቱት ካርታ ከሌለ pass ማለት አለባቹ።</li>
        </ul>
    </div>
</div>
...
<div class="modal-section">
    ...
    <div class="modal-section-content">
        <ul>
            <li><strong>2:</strong> ቀጣዩ ሰው ወይ 2 ይስባል አልያ 2 መጣል አለበት ከዛሚቀጥለው 4 ይስባል።</li>
            <li><strong>5:</strong> እንደ ማዘለያ ነው ጥቅሟ ስለዚህ እናንተን ያስደግማል።</li>
            <li><strong>7:</strong> ብቻዋን ከተጣለች እንደ ማዘለያ ይጠቅማል ነገር ግን ሌሎች ካርታወችን ለማውረድ ያገለግላል ለምሳሌ 7 ልብ ቢኖረኝ ያለኝን ልብ በሙሉ ማውረድ ችላለው።</li>
            <li><strong>8 / J:</strong> ሁለቱንም ካርታ የፈለግነው ካርታ ላይ መጣል ይቻላል ከዛም በመቀጠል ጫዋታውን ወደፈለጉት suit መቀየር ይቻላል ነገር ግን ይህ ማይሰራው ከእናንተ አንድ ዙር ቀደም ብሎ አዞ ከነበር መቀየር አይቻልም ግን እንደ በማለት መጫወት ይቻላል ።</li>
            <li><strong>A ጦር:</strong> አንድ ሰው ይህን ከጣለ ቀጣዩ ሰው  ወይ 5 ይስባል አልያ 2 ጦር መጣል ይችላል</li>
        </ul>
    </div>
</div>
